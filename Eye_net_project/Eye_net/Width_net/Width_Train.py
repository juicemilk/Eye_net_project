...
width_train:the network topology of training net
...
def width_train(Activation_mode,Regularization_mode,Cost_mode,Loss_mode,Is_batch_normalization,Regularization_rate,Learning_rate,Keep_prob,MOMENTUM,Epochs,Batch_size,train_data,test_data,Data_max,Data_min,Use_type,Models_save_path,Model_name,Save_model_num,Use_tensorboard):
    ...
    with tf.name_scope('dnn_all'):
        ALL_INPUT = tf.concat([TX_LAYER2_OUTPUT,S_LAYER2_OUTPUT,RX_LAYER2_OUTPUT],1,name = 'all_input')  
        
        LAYER3_OUTPUT = my_dense_layer(ALL_INPUT, LAYER3_NODE, training, keep_prob, Activation_mode, Regularization_mode, Is_batch_normalization, Regularization_rate, 'layer3', 'layer3_output') 
           
        LAYER4_OUTPUT = my_dense_layer(LAYER3_OUTPUT, LAYER4_NODE, training, keep_prob, Activation_mode, Regularization_mode, Is_batch_normalization, Regularization_rate, 'layer4', 'layer4_output')
        ...
        logits = my_logits_layer(LAYER6_OUTPUT, LAYER7_NODE, training, keep_prob, Regularization_mode, Is_batch_normalization, Regularization_rate, 'logits_layer', 'logits')
    ...
    with tf.name_scope('loss'):
        if Cost_mode=='1':
            ...
            print('please input correct cost mode')
